...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recognize?.setOnClickListener(View.OnClickListener {
            ...
            face_preview?.visibility = View.INVISIBLE
            Log.v("registeredlist", registered.toString())
...
//        val sharedPreferences = getSharedPreferences("HashMap", MODE_PRIVATE)
        ...
        Log.v("nameinpreferevce", retrievedMap.toString())
...
//                    reco_name!!.text = name
                    ...
                    editor.apply()
                    Toast.makeText(this, "Login Successfully" + name, Toast.LENGTH_SHORT)
                        .show()
